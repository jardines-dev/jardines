    ...
    <div>
        <div class="u-flex-center u-responsive-after"
            ...
            <div class="u-flex-between">
                <div class="u-flex-between" >
                    <img src="../../assets/img/navbar/phone.svg" />
                    <div class="u-navbar-phone-text">Línea contacto:<br><span>(01)<?php 999999?></span>
                    </div>
                </div>
                <!--
                <div class="u-navbar-phone-text">Línea gratuita:<br><span><?php 999999999?></span></div>
                -->
            </div>
        </div>
        ...
        <div class="main_page_header u-flex-between" style="min-height:auto">
            ...
            <a href="#u-home-sec_2" class="u-scroll_btn u-flex-around">
                <img src="./assets/img/home_page/scroll.svg">
            </a>
            <a class="u-covid u-flex-center" href="https://tienda.jardines.pe/registrar-visita/" target="_blank"><img src="./assets/img/home_page/arrown_top.svg">
                 VISITAS A CAMPOSANTOS Y PROTOCOLO DE BIOSEGURIDAD AQUI
                <img src="./assets/img/home_page/arrown_top.svg">
            </a>
        </div>
        <!-- header html code -->
        <!-- section2 html code -->
        ...
        <div class="u-home-sec_7">
            ...
            <div class="u-home-3carousel-body u-flex-around u-responsive-before"></div>
                           
                <div class="u-home-3carousel-btns u-flex-around u-flex-column"></div>
